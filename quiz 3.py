...
# from taxi import Ui_MainWindow
#
#
...
#             msg.setText("მისამართის ველი ცარიელია! გთხოვთ შეავსეთ.")
#             msg.exec_()
#             return
#
...
#
#         msg = QMessageBox()
#         msg.setWindowTitle("შეკვეთის ინფორმაცია")
#         msg.setText(message)
#         msg.exec_()
#
#     # დროის განახლება
#     def update_time(self):
#         current_time = QtCore.QDateTime.currentDateTime().toString("HH:mm:ss dd.MM.yyyy")
#         self.timer_label.setText("დრო: " + current_time)
#
#     # ფასი ტაქსის ტიპის მიხედვით
#     def update_price(self, text):
#         prices = {"ეკონომი": 5, "სტანდარტი": 10, "ბიზნესი": 20, "მინივენი": 15}
#         price = prices.get(text, 0)
#         self.price_label.setText(f"ფასი: {price}₾")
#
#     # ღამის რეჟიმი
...
# from taxxi import Ui_MainWindow  # შენი autogenerated UI კლასი
#
# class TaxiApp(QtWidgets.QMainWindow, Ui_MainWindow):
#     def __init__(self):
#         super().__init__()
...
#         self.lineEdit.textChanged.connect(self.on_address_changed)
#         self.comboBox_2.currentTextChanged.connect(self.update_price)
#         self.modebox.stateChanged.connect(self.toggle_dark_mode)
#
#         self.timer = QtCore.QTimer()
#         self.timer.timeout.connect(self.update_time)
#         self.timer.start(1000)
...
#             self.timelabel.setStyleSheet("border: 1px solid red;")
#
...
#             self.modebox.setStyleSheet("color: white; background: #2b2b2b")
